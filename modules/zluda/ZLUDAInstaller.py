...
def install(zluda_path: os.PathLike) -> None:
    ...
    urllib.request.urlretrieve(
        f"https://github.com/lshqqytiger/ZLUDA/releases/download/{RELEASE}/ZLUDA-windows-amd64.zip", "_zluda"
    )
...
def load(zluda_path: os.PathLike) -> None:
    ...
    if hip_path is None:
        raise RuntimeError(
            "Could not find AMD HIP SDK, please install it from https://www.amd.com/en/developer/resources/rocm-hub/hip-sdk.html"
        )
