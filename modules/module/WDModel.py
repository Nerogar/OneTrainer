...
class WDModel(BaseImageCaptionModel):
    def __init__(self, device: torch.device, dtype: torch.dtype):
        ...
        model_path = huggingface_hub.hf_hub_download("SmilingWolf/wd-v1-4-vit-tagger-v2", "model.onnx")
        if device.type == "cpu":
        ...
        label_path = huggingface_hub.hf_hub_download("SmilingWolf/wd-v1-4-vit-tagger-v2", "selected_tags.csv")
        self.tag_names = []
        self.rating_indexes = []
    ...
    def generate_caption(
        ...
        predicted_caption = ", ".join([label[0].replace("_", " ") for label in sorted_general_labels])
