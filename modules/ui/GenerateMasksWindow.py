...
class GenerateMasksWindow(ctk.CTkToplevel):
    def __init__(
        ...
        self.model_label = ctk.CTkLabel(
            self.frame, text="Model", width=100
        )
        ...
        self.path_label = ctk.CTkLabel(
            self.frame, text="Folder", width=100
        )
        ...
        self.prompt_label = ctk.CTkLabel(
            self.frame, text="Prompt", width=100
        )
        ...
        self.threshold_label = ctk.CTkLabel(
            self.frame, text="Threshold", width=100
        )
        self.threshold_label.grid(
            row=4, column=0, sticky="w", padx=5, pady=5
        )
        self.threshold_entry = ctk.CTkEntry(
            self.frame, width=200, placeholder_text="0.0 - 1.0"
        )
        ...
        self.include_subdirectories_label = ctk.CTkLabel(
            self.frame, text="Include subfolders", width=100
        )
        ...
        self.progress_label = ctk.CTkLabel(
            self.frame, text="Progress: 0/0", width=100
        )
        ...
        self.create_masks_button = ctk.CTkButton(
            self.frame,
            text="Create Masks",
            width=310,
            command=self.create_masks,
        )
        self.create_masks_button.grid(
