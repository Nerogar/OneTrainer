...
class OptimizerParamsWindow(ctk.CTkToplevel):
    ...
    def create_dynamic_ui(
        ...
        KEY_DETAIL_MAP = {
            ...
            'weight_decay_by_lr': {'title': 'weight_decay_by_lr', 'tooltip': 'Use weight_decay_by_lr', 'type': 'bool'},
            'weight_decay_by_lr': {'title': 'weight_decay_by_lr', 'tooltip': 'Use weight_decay_by_lr', 'type': 'bool'},
            'prodigy_steps': {'title': 'prodigy_steps', 'tooltip': 'Turn off Prodigy after N steps', 'type': 'int'},
            'use_speed': {'title': 'use_speed', 'tooltip': 'use_speed', 'type': 'bool'},
            'split_groups': {'title': 'split_groups', 'tooltip': 'Use split_groups', 'type': 'bool'},
            'split_groups_mean': {'title': 'split_groups_mean', 'tooltip': 'Use split_groups_mean', 'type': 'bool'},
            ...
            'use_stableadamw': {'title': 'use_stableadamw', 'tooltip': 'Use use_stableadamw', 'type': 'bool'},
            'use_muon_pp': {'title': 'use_muon_pp', 'tooltip': 'Use use_muon_pp', 'type': 'bool'},
            'use_cautious': {'title': 'use_cautious', 'tooltip': 'Use se_cautious', 'type': 'bool'},
            'use_grams': {'title': 'use_grams', 'tooltip': 'Use use_grams', 'type': 'bool'},
            'use_adopt': {'title': 'use_adopt', 'tooltip': 'Use use_adopt', 'type': 'bool'},
            'use_focus': {'title': 'use_focus', 'tooltip': 'Use use_focus', 'type': 'bool'},
        }
        # @formatter:on
