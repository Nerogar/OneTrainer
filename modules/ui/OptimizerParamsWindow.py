...
class OptimizerParamsWindow(ctk.CTkToplevel):
    ...
    def create_dynamic_ui(
        ...
        KEY_DETAIL_MAP = {
            ...
            'use_speed': {'title': 'use_speed', 'tooltip': 'use speed method', 'type': 'bool'},
            'split_groups': {'title': 'split_groups', 'tooltip': 'Use split groups when training multiple parts(uNet,TE..)', 'type': 'bool'},
            'split_groups_mean': {'title': 'split_groups_mean', 'tooltip': 'Use split groups mean', 'type': 'bool'},
            ...
            'use_cautious': {'title': 'use_cautious', 'tooltip': 'Use cautious', 'type': 'bool'},
            'use_grams': {'title': 'use_grams', 'tooltip': 'Use grams method', 'type': 'bool'},
            'use_adopt': {'title': 'use_adopt', 'tooltip': 'Use adopt', 'type': 'bool'},
            'use_focus': {'title': 'use_focus', 'tooltip': 'Use focus', 'type': 'bool'},
        }
        # @formatter:on
