...
class OptimizerParamsWindow(ctk.CTkToplevel):
    ...
    def create_dynamic_ui(
        ...
        KEY_DETAIL_MAP = {
            ...
            'sinkhorn': {'title': 'Multi-Normed Sinkhorn', 'tooltip': 'Applies fast iterative row and column normalization to distribute weight updates evenly while giving some room to the original gradient\'s direction. This serves as a "soft," smoothed alternative to orthogonalization, which is theoretically better.', 'type': 'bool'},
