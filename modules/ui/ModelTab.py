        ...
        if has_prior:
            if allow_override_prior:
                ...
                components.label(self.scroll_frame, row, 0, "Prior Model",
                                 tooltip="Filename, directory or Hugging Face repository of the prior model. For Flux or Chroma, it must be a safetensors file that only contains the transformer.")
                components.file_entry(
