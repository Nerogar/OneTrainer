...
class ZImageModelSaver(
    ...
    def __save_safetensors(
        ...
        print(
            "Warning: Comfy can only load their own incompatible format of Z-Image full finetunes. To use this file in Comfy, it can be converted using https://huggingface.co/Comfy-Org/z_image_turbo/resolve/main/z_image_convert_original_to_comfy.py"
        )
