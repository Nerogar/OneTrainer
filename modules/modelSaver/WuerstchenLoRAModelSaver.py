...
class WuerstchenLoRAModelSaver(BaseModelSaver):
    ...
    @staticmethod
    def __get_state_dict(model: WuerstchenModel) -> dict[str, Tensor]:
        state_dict = {}
    ...
    def __save_ckpt(
        ...
        state_dict = WuerstchenLoRAModelSaver.__get_state_dict(model)
    ...
    def __save_internal(
        ...
        # lora
        WuerstchenLoRAModelSaver.__save_safetensors(
            model,
