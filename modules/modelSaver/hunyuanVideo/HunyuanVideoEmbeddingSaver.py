    ...
    def _to_state_dict(
        ...
        if embedding is not None:
            if embedding.text_encoder_1_embedding.vector is not None:
                state_dict["llama"] = embedding.text_encoder_1_embedding.vector.to(device="cpu", dtype=dtype)
            if embedding.text_encoder_2_embedding.vector is not None:
                state_dict["clip_l"] = embedding.text_encoder_2_embedding.vector.to(device="cpu", dtype=dtype)
