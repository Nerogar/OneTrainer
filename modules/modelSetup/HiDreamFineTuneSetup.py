...
class HiDreamFineTuneSetup(
    ...
    def create_parameters(
        ...
        self._create_model_part_parameters(
            parameter_group_collection, "text_encoder_3", model.text_encoder_3, config.text_encoder_3
        )
        self._create_model_part_parameters(
            parameter_group_collection, "text_encoder_4", model.text_encoder_4, config.text_encoder_4
        )
    ...
    def __setup_requires_grad(
        ...
        self._setup_model_part_requires_grad(
            "text_encoder_3", model.text_encoder_3, config.text_encoder_3, model.train_progress
        )
        self._setup_model_part_requires_grad(
            "text_encoder_4", model.text_encoder_4, config.text_encoder_4, model.train_progress
        )
        self._setup_model_part_requires_grad(
            "transformer",
            model.transformer,
