...
def build_muon_adam_key_fn(
    ...
    if config.optimizer.muon_hidden_layers is not None:
        ...
        match model.model_type:
            ...
            case ModelType.STABLE_DIFFUSION_3 | ModelType.STABLE_DIFFUSION_35 | ModelType.SANA  | ModelType.FLUX_DEV_1  | ModelType.FLUX_2 | ModelType.CHROMA_1  | ModelType.QWEN  | ModelType.PIXART_ALPHA | ModelType.PIXART_SIGMA | ModelType.LENS:
                default_patterns = [
                    'transformer_blocks',
                    'encoder.block', # TE (T5)
                ]
