...
def __map_unet_down_blocks(key_prefix: LoraConversionKeySet) -> list[LoraConversionKeySet]:
    ...
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "1.1"), combine(key_prefix.diffusers_prefix, "0.attentions.0"))]
    ...
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "2.1"), combine(key_prefix.diffusers_prefix, "0.attentions.1"))]
    ...
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "9.0.op"), combine(key_prefix.diffusers_prefix, "2.downsamplers.0.conv"))]

    keys += __map_unet_resnet_block(LoraConversionKeySet(combine(key_prefix.omi_prefix, "10.0"), combine(key_prefix.diffusers_prefix, "3.resnets.0")))
    keys += __map_unet_resnet_block(LoraConversionKeySet(combine(key_prefix.omi_prefix, "11.0"), combine(key_prefix.diffusers_prefix, "3.resnets.1")))
...
def __map_unet_up_block(key_prefix: LoraConversionKeySet) -> list[LoraConversionKeySet]:
    ...
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "6.1"), combine(key_prefix.diffusers_prefix, "2.attentions.0"))]
    ...
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "7.1"), combine(key_prefix.diffusers_prefix, "2.attentions.1"))]
    ...
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "8.1"), combine(key_prefix.diffusers_prefix, "2.attentions.2"))]
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "8.2.conv"), combine(key_prefix.diffusers_prefix, "2.upsamplers.0.conv"))]

    keys += __map_unet_resnet_block(LoraConversionKeySet(combine(key_prefix.omi_prefix, "9.0"), combine(key_prefix.diffusers_prefix, "3.resnets.0")))
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "9.1"), combine(key_prefix.diffusers_prefix, "3.attentions.0"))]
    keys += __map_unet_resnet_block(LoraConversionKeySet(combine(key_prefix.omi_prefix, "10.0"), combine(key_prefix.diffusers_prefix, "3.resnets.1")))
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "10.1"), combine(key_prefix.diffusers_prefix, "3.attentions.1"))]
    keys += __map_unet_resnet_block(LoraConversionKeySet(combine(key_prefix.omi_prefix, "11.0"), combine(key_prefix.diffusers_prefix, "3.resnets.2")))
    keys += [LoraConversionKeySet(combine(key_prefix.omi_prefix, "11.1"), combine(key_prefix.diffusers_prefix, "3.attentions.2"))]
...
def convert_sd_lora_key_sets() -> list[LoraConversionKeySet]:
    ...
    keys += __map_text_encoder(LoraConversionKeySet("lora_clip_l", "lora_te"))
