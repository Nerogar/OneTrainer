...
class TrainArgs(BaseArgs):
    ...
    def default_values() -> 'TrainArgs':
        ...
        data.append(("optimizer_adam_w_mode", True, bool, True))
        data.append(("optimizer_alpha", 0.99, float, False))
        data.append(("optimizer_amsgrad", False, bool, True))
        ...
        data.append(("optimizer_bias_correction", True, bool, True))
        data.append(("optimizer_block_wise", True, bool, True))
        data.append(("optimizer_capturable", False, bool, True))
        data.append(("optimizer_centered", False, bool, True))
        ...
        data.append(("optimizer_decouple", False, bool, True))
        data.append(("optimizer_differentiable", True, bool, True))
        data.append(("optimizer_eps", 1e-8, float, False))
        data.append(("optimizer_eps2", 1e-3, float, False))
        data.append(("optimizer_foreach", False, bool, True))  # Disabled, because it uses too much VRAM
        data.append(("optimizer_fsdp_in_use", False, bool, True))
        data.append(("optimizer_fused", True, bool, True))
        data.append(("optimizer_growth_rate", float('inf'), float, False))
        data.append(("optimizer_initial_accumulator_value", 0, int, False))
        data.append(("optimizer_is_paged", False, bool, True))
        ...
        data.append(("optimizer_maximize", False, bool, True))
        data.append(("optimizer_min_8bit_size", 4096, int, False))
        data.append(("optimizer_momentum", 0.99, float, False))
        data.append(("optimizer_nesterov", False, bool, True))
        data.append(("optimizer_no_prox", False, bool, True))
        data.append(("optimizer_optim_bits", 32, int, False))
        data.append(("optimizer_percentile_clipping", 100, float, False))
        data.append(("optimizer_relative_step", True, bool, True))
        data.append(("optimizer_safeguard_warmup", True, bool, True))
        data.append(("optimizer_scale_parameter", True, bool, True))
        data.append(("optimizer_use_bias_correction", True, bool, True))
        data.append(("optimizer_use_triton", False, bool, True))
        data.append(("optimizer_warmup_init", False, bool, True))
