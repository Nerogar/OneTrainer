...
class GenerateMasksArgs(BaseArgs):
    ...
    def parse_args() -> "GenerateMasksArgs":
        ...
        parser.add_argument(
            "--model",
            type=GenerateMasksModel,
            required=True,
            dest="model",
            help="The model to use when generating masks",
            choices=list(GenerateMasksModel),
        )
        parser.add_argument(
        ...
        parser.add_argument(
            ...
            required=False,
            dest="mode",
            help="Either replace, fill, add, subtract or blend",
        )
        parser.add_argument(
            "--threshold",
            type=float,
        ...
        parser.add_argument(
            ...
            default=1.0,
            dest="alpha",
            help="The factor to weight the mask by. Default is 1.",
        )
        parser.add_argument(
