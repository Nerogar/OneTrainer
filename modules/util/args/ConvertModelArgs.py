...
class ConvertModelArgs(BaseArgs):
    ...
    def parse_args() -> "ConvertModelArgs":
        ...
        parser.add_argument(
            ...
            type=TrainingMethod,
            required=False,
            default=TrainingMethod.FINE_TUNE,
            dest="training_method",
            help="The training method",
            choices=list(TrainingMethod),
        )
        ...
        parser.add_argument(
            ...
            dest="output_dtype",
            help="The data type to save the output model",
        ...
        parser.add_argument(
            ...
            help="The format to save the final output model",
        ...
        parser.add_argument(
            ...
            type=str,
            required=True,
            dest="output_model_destination",
            help="The destination to save the final output model",
        )
