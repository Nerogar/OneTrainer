...
class PixArtAlphaBaseDataLoader(BaseDataLoader):
    ...
    def _preparation_modules(self, config: TrainConfig, model: PixArtAlphaModel):
        ...
        encode_prompt = EncodeT5Text(tokens_in_name='tokens', tokens_attention_mask_in_name='tokens_mask', hidden_state_out_name='text_encoder_hidden_state', pooled_out_name=None, add_layer_norm=True, text_encoder=model.text_encoder, hidden_state_output_index=-(1 + config.text_encoder_layer_skip), autocast_context=model.text_encoder_autocast_context)
