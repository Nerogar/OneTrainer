...
class StablDiffusionBaseDataLoader(BaseDataLoader):
    ...
    def _preparation_modules(self, config: TrainConfig, model: StableDiffusionModel):
        ...
        encode_prompt = EncodeClipText(in_name='tokens', hidden_state_out_name='text_encoder_hidden_state', pooled_out_name=None, add_layer_norm=True, text_encoder=model.text_encoder, hidden_state_output_index=-(1 + config.text_encoder_layer_skip), autocast_context=model.autocast_context)
