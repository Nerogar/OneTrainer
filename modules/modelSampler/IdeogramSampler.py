...
class IdeogramSampler(BaseModelSampler):
    ...
    def __encode(
        ...
        return {
            "use_cfg": use_cfg,
            "use_unconditional_transformer": use_unconditional_transformer,
            "use_empty_prompt_negative": use_empty_prompt_negative,
            "text_features": text_features,
            "text_lengths": text_lengths,
            "neg_text_features": neg_text_features,
            "neg_text_lengths": neg_text_lengths,
        }
    ...
    def __denoise(
            ...
            sample_config: SampleConfig,
            use_cfg: bool,
            use_unconditional_transformer: bool,
            use_empty_prompt_negative: bool,
            text_features: torch.Tensor,
            text_lengths: torch.Tensor,
            neg_text_features: torch.Tensor | None,
            neg_text_lengths: torch.Tensor | None,
            on_update_progress: Callable[[int, int], None],
    ) -> dict:
        # the unconditional transformer is only needed for asymmetric CFG's negative branch
