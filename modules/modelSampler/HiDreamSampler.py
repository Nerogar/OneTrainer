...
class HiDreamSampler(BaseModelSampler):
    ...
    def __encode(
        ...
        return {
            "combined_text_encoder_3_prompt_embedding": combined_text_encoder_3_prompt_embedding,
            "combined_text_encoder_4_prompt_embedding": combined_text_encoder_4_prompt_embedding,
    ...
    def __denoise(
            self,
            sample_config: SampleConfig,
            combined_text_encoder_3_prompt_embedding: torch.Tensor,
